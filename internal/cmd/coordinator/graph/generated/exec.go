...
type ComplexityRoot struct {
	...
	Mutation struct {
		AllocateGame func(childComplexity int) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "AllocateGamePayload.address":
		if e.complexity.AllocateGamePayload.Address == nil {
			break
		}
...
func (ec *executionContext) _AllocateGamePayload_address(ctx context.Context, field graphql.CollectedField, obj *model.AllocateGamePayload) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
...
func (ec *executionContext) _Mutation_allocateGame(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AllocateGame(rctx)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
var allocateGamePayloadImplementors = []string{"AllocateGamePayload"}

func (ec *executionContext) _AllocateGamePayload(ctx context.Context, sel ast.SelectionSet, obj *model.AllocateGamePayload) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, allocateGamePayloadImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("AllocateGamePayload")
		case "address":
			out.Values[i] = ec._AllocateGamePayload_address(ctx, field, obj)
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "allocateGame":
			out.Values[i] = ec._Mutation_allocateGame(ctx, field)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) marshalOAllocateGamePayload2ᚖgithubᚗcomᚋnhanᚑngᚋsudokuᚋinternalᚋcmdᚋcoordinatorᚋgraphᚋmodelᚐAllocateGamePayload(ctx context.Context, sel ast.SelectionSet, v *model.AllocateGamePayload) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._AllocateGamePayload(ctx, sel, v)
}
